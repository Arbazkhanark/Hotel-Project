  ...
  return (
    <>
      ...
      <header>
        <div className='container flex_space'>
          <div className='logo'>
            <img src='/images/Black And White Minimalist House Illustration Rent Villa Logo (2).png' alt=''  className="logo-img"/>
          </div>
          ...
          <div className='contact flex_space '>
            ...
            <div className='box flex_space'>
              ...
              <div className='text'>
                ...
                <Link to='/contact'>+91 89681-53477</Link>
              </div>
            </div>
            <div className='box flex_space'>
              <div className='icons'>
              ...
              <div className='text'>
                <h4>Mail Us</h4>
                <Link to='/contact'>info@hoteldelluna.com</Link>
              </div>
            </div>
          </div>
        </div>
